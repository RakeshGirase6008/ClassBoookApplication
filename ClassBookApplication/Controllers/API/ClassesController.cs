            ...
            try
            {
                ...
                if (classesData != null)
                {
                    ...
                    if (!singleUser.Any())
                    {
                        ...
                        string password = _classBookService.SaveUserData(classesId, Module.Classes, UserName, classesData.Email);
                        await Task.Run(() => _classBookService.SendVerificationLinkEmail(classesData.Email, password, Module.Classes.ToString()));
